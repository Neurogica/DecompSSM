...
from models.decompssm.components import OurModule
...
class SSM(OurModule):
    ...
    def init_heads(self, n_heads: int, head_dim: int):
        if head_dim is None:
            self.head_dim = self.model_dim // (self.kernel_repeat * self.n_kernels * n_heads)
            self.n_heads = n_heads
        else:
            self.head_dim = head_dim
            self.n_heads = self.model_dim // (self.kernel_repeat * self.n_kernels * head_dim)
